 ...
 * Description: Bevshop class that implements the Bevshop interface that includes more details for each beverage.
 * Due: 5/7/2023
...
abstract class BevShop implements BevShopInterface{
    ...
    public boolean eligibleForMore() {
        int numAlcoholDrinks = getNumOfAlcoholDrink();
        return numAlcoholDrinks < 3;
    }
